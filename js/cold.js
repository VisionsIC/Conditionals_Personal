...
window.location="ski.htm" // if user types "ski", the browser will load the appropriate page.
break; // haults the JavaScript code.
    case "hike": // if case matches "hike" typed by user, an appropriate action will occur. 
window.location="hike.htm" // if user types "hike", the browser will load the appropriate page.
break; // haults the JavaScript code.
