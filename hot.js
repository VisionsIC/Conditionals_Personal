...
window.location="beach.htm" // if user types "beach", the browser will load the appropriate page.
break; // haults the JavaScript code.
    case "golf": // if case matches "golf" typed by user, an appropriate action will occur.
window.location="golf.htm" // if user types "golf", the browser will load the appropriate page.
break; // haults the JavaScript code.
